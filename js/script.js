...
$document.ready(function () {
  ...
  if (plugins.swiper.length) {
    plugins.swiper.each(function () {
      ...
      s.find(".swiper-slide")
          ...
          .end()
          .swiper({
            autoplay: s.attr('data-autoplay') === "true" ? 5000 : true,
            ...
            scrollbarHide: bar.length ? bar.attr("data-draggable") === "false" : true,
            ...
            onSlideChangeStart: function (swiper) {
              var activeSlideIndex, slidesCount, thumbsToShow = 4;
  ...
  if (lastupdate.length) {
    lastupdate.text(initialDate.toDateString());
  }
